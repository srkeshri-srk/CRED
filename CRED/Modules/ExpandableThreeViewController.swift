//
//  ExpandableThreeViewController.swift
//  CRED
//
...
class ExpandableThreeViewController: UIViewController {
    // define lazy views
...
extension ExpandableThreeViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            cell.configureUI(info: HeaderInfo(titleText: "where should we send the money?", subTitleText: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque convallis luctus augue."))
            return cell
            ...
            cell.configureUI(title: "change account")
            return cell
        }
    }
